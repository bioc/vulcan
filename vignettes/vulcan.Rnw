...
%--------
\section{Citation}
Holding AN, Giorgi FM, Donnelly A, Cullen AE, Nagarajan S, Selth, LA and
Markowetz F (2016) VULCAN integrates ChIP-seq with patient-derived
co-expression networks to identify GRHL2 as a key co-regulator of ERa at
enhancers in breast cancer. Genome Biology 20(1):91
%--------
...
Nagarajan, S., Selth, L.A.,and Markowetz, F. (2016). VULCAN integrates ChIP-seq
with patient-derived co-expression networks to identify GRHL2 as a key
co-regulator of ERa at enhancers in breast cancer. Genome Biology 20(1):91
